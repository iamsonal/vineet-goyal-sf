...
function commerceStorePricingTestUtilConfig(config) {
    const { compat } = config;
    return {
        input: path.join(__dirname, 'karma', 'commerce-store-pricing-test-util.js'),
        output: {
            file: getTargetPath('commerce-store-pricing-test-util.js', compat),
            format: 'umd',
            name: 'commerceStorePricingTestUtil',
            globals: {
    ...
    return {
        ...
        output: {
            ...
            globals: {
                ...
                '@ldsjs/engine': 'ldsEngine',
                '@ldsjs/lwc-lds': 'lwcLds',
                '@salesforce/lds-adapters-commerce-store-pricing': 'commerceStorePricingService',
            },
        },
        external: [
            'sinon',
...
module.exports = [
    ...
    commerceStorePricingTestUtilConfig({ compat: false }),
    commerceStorePricingTestUtilConfig({ compat: true }),
    ldsWebviewConfig(),
];
