    ...
    describe('read', () => {
        ...
        it('logs read event when getRelatedListRecords is called', async () => {
            ...
            const response = {
                ...
                currentPageToken: '0',
                currentPageUrl:
                    '/services/data/v52.0/ui-api/related-list-records/001RM000004km7aYAA/Contacts?fields=Contact.Id%2CContact.Name&optionalFields=Contact.Email%2CContact.LastName&pageSize=50&pageToken=0',
                fields: ['Contact.Id', 'Contact.Name'],
                listInfoETag: null,
                listReference: {
                    id: null,
                ...
                results: [
                    {
                        result: {
                            ...
                            currentPageToken: '0',
                            currentPageUrl:
                                '/services/data/v52.0/ui-api/related-list-records/a00RM0000004aVwYAI/CwcCustom02s__r?pageSize=50&pageToken=0',
                            fields: [],
                            listInfoETag: null,
                            listReference: {
                                id: null,
                    ...
                    },
                    {
                        result: {
                            ...
                            currentPageToken: 0,
                            currentPageUrl:
                                '/services/data/v52.0/ui-api/related-list-records/a00RM0000004aVwYAI/CwcCustom01s__r?pageSize=50&pageToken=0',
                            fields: [],
                            listInfoETag: null,
                            listReference: {
                                id: null,
